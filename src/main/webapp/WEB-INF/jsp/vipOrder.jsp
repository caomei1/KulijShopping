  ...
  <div class="vipLeft">
   ...
   <dl class="vipNav">
    <dt class="vip_1 vipCur">买家中心</dt>
     <dd class="ddCur"><a href="vipOrder">我的订单</a></dd>
     <dd><a href="vipShoucang">收藏关注</a></dd>
    <dt class="vip_2">账户设置</dt>
     <dd><a href="vip">个人信息</a></dd>
     <dd><a href="vipPwd">密码修改</a></dd>
     <dd><a href="vipAddress">收货地址</a></dd>
     <dd><a href="vipXiaofei">消费记录</a></dd>
    <dt class="vip_3">客户服务</dt>
     <dd><a href="vipQuxiao">取消订单/退货</a></dd>
     
     <dd><a href="vipTousu">我的投诉</a></dd>
   </dl><!--vipNav/-->
  </div><!--vipLeft/-->
  <div class="vipRight">
   <h2 class="oredrName">
    	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;全部订单 
    	<span style="margin-left:40px;">待付款 <span class="red"></span></span>
    	<span style="margin-left:40px;">待发货 <span class="red">10</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    	<span>待收货 <span class="red">15</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    	<span>待评价 <span class="red">15</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <table class="vipOrder">
     <tr>
      <td><a href="proinfo"><img src="${contextPath}/assets/images/phone.png" width="60" height="55"></a></td>
      <td>张益达</td>
      <td>￥16.9<br />微信支付</td>
      <td>2014年6月23日11:32:17</td>
      <td><a href="success"><strong>支付成功</strong></a></td>
      <td><a href="vipXiaofei">查看</a></td>
     </tr>
     <tr>
      <td><a href="proinfo"><img src="${contextPath}/assets/images/phone.png" width="60" height="55"></a></td>
      <td>张益达</td>
